  ...
  return (
    <div className="w-full border border-[#f1c40f]/30 p-6 rounded bg-[#2a2a2a] font-sans shadow-lg">
      ...
      <div className="flex items-center mb-4">
        <div
          className={`w-[45px] font-bold ${votes.yes >= votes.no ? "text-[#f1c40f]" : ""}`}
        >
          Yes
        </div>
        ...
        <div className="w-[45px] text-right font-semibold text-[#f5f5f5]">
          {votes.yes}%
        </div>
      </div>
      <div className="flex items-center mb-4">
        <div
          className={`w-[45px] font-bold ${votes.no > votes.yes ? "text-[#f1c40f]" : ""}`}
        >
          No
        </div>
        <div className="flex-grow h-[18px] bg-white/10 mx-3 rounded overflow-hidden">
