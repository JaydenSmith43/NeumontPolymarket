...
-- Bet tags junction table
CREATE TABLE public.bet_tags (
...
GRANT INSERT, SELECT ON public.tags TO authenticated;
GRANT SELECT ON public.bet_tags TO anon, authenticated;
GRANT INSERT, SELECT ON public.bet_tags TO authenticated;
